...
// throw new XxlRpcException("xxl-rpc remoting request fail, http HttpStatus["+ result.getResponse().getStatus() +"]
// invalid.");
// }
//
...
// XxlRpcResponse xxlRpcResponse = (XxlRpcResponse) xxlRpcReferenceBean.getSerializer().deserialize(responseBytes,
// XxlRpcResponse.class);
//
// // notify response
...
// XxlRpcRequest requestTmp = (XxlRpcRequest)
// xxlRpcReferenceBean.getSerializer().deserialize(requestCp.iterator().next().array(), XxlRpcRequest.class);
//
// // error msg
