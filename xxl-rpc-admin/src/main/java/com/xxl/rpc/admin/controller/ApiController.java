...
public class ApiController {
     ...
     *
     * 请求参数说明： 1、accessToken：请求令牌； 2、biz：业务标识 2、env：环境标识 3、registryDataList：服务注册信息
     *
     * 请求数据格式如下，放置在 RequestBody 中，JSON格式：
     *
     * { "accessToken" : "xx", "biz" : "xx", "env" : "xx", "registryDataList" : [{ "key" : "service01", "value" :
     * "address01" }] }
     *
     * @param data
     * @return
     ...
     *
     * 请求参数说明： 1、accessToken：请求令牌； 2、biz：业务标识 2、env：环境标识 3、keys：服务注册Key列表
     *
     * 请求数据格式如下，放置在 RequestBody 中，JSON格式：
     *
     * { "accessToken" : "xx", "biz" : "xx", "env" : "xx", "keys" : [ "service01", "service02" ] }
     *
     * @param data
     * @return
     */
